...
function initialize() {
  ...
  if (nodemap) {    
    var mapOptions = {
        zoom: 14,
        center: new google.maps.LatLng(37.398837, -122.146516),
  ...
  var styledMap = new google.maps.StyledMapType(style1,{name:"Styled Map"});
      ...
      if (!nodemap) {
          ...
          var trucksarray = ['Select a Truck', 328121,198653,193871];
    ...
    if (nodemap) {
      ...
      //new Truck(map,new google.maps.LatLng(37.42565, -122.155940),193871,2013223,80,2,'07:30','15:00');
          ...
          startAddress = '3410 Hillview Ave, Palo Alto, CA 94304';
          ...
          var customer0 = {name : "Customer 1", address : '14 E Charleston Rd, Palo Alto, CA 94303', orderid : 34567, phone : '408 743 8765',start : '--:--',lead : '30:00',selected : false };
          var customer2 = {name : "Customer 3", address : '1747 Grant Rd, Mountain View, CA 94040', orderid : 34568, phone : '408 452 4321',start : '--:--',lead : '30:00',selected : false };
          var customer1 = {name : "Customer 2", address : '301 N Whisman Rd, Mountain View, CA 94043', orderid : 34569, phone : '408 932 0184',start : '--:--',lead : '30:00',selected : false };
